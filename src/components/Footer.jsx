...
const Footer = () => {
  return (
    <footer className="bg-fz-dark text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <a 
              ...
              className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:border-fz-green hover:text-fz-green transition-all duration-300"
              aria-label="Facebook"
            >
